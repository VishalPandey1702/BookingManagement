  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="bg-blue-500 text-white py-20">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg md:text-xl mb-8">
            Manage your bookings, view schedules, and join classes seamlessly
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-80">
              ...
              <p className="text-gray-600">
                Reserve your spot in classes with just a few clicks. Choose your
                time and activity effortlessly.
              </p>
            </div>
            {/* Feature Card 2 */}
            <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-80">
              ...
              <p className="text-gray-600">
                View and manage your class schedules in real-time, with
            ...
            <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-80">
              ...
              <p className="text-gray-600">
                Track your bookings, view history, and manage your profile from
      ...
      <section className="bg-gray-800 text-white py-16">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg mb-8">
            Sign up today and start booking your Play Academy classes in
            seconds!
          </p>
          <Link
            href="/signup"
      ...
      <footer className="bg-blue-600 text-white py-6">
        <div className="container mx-auto text-center">
          <p>
            &copy; {new Date().getFullYear()} Play Academy. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
